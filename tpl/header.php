...
<nav id="navbar" class="navbar navbar-expand-lg navbar-<?php echo $wbcnf['nav-var'] ?> text-center">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ml-auto mx-auto">
      <li class="nav-item">
        <a class="nav-link" href="/"><i class="fas fa-home" style="line-height: 0px !important;"></i>&nbsp;&nbsp;ACCUEIL</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/news"><i class="fas fa-newspaper" style="line-height: 0px !important;"></i>&nbsp;&nbsp;NEWS</a>
      </li>
    ...
    <form class="form-inline my-2 my-lg-0" method="POST">
      ...
      if(isset($logged) && $logged === true) {
        echo '<div><div class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-'.$wbcnf['text-var'].'" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="text-transform: uppercase;">
        <i class="fas fa-key"></i>&nbsp;&nbsp;MON COMPTE
        &nbsp;&nbsp;&nbsp;&nbsp;<span class="badge badge-primary">0</span>
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="/profile/'.$usrnm.'">PROFIL</a>
          <a class="dropdown-item" href="/mailbox">MESSAGERIE
          &nbsp;&nbsp;&nbsp;&nbsp;<span class="badge badge-danger">0</span></a>
          <a class="dropdown-item" href="/settings">PREFERENCES</a>
          <div class="dropdown-divider"></div>
          <button class="dropdown-item" type="submit" name="logout">DECONNEXION</button>
        </div>';
      } else {
        echo '<div><div class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-'.$wbcnf['text-var'].'" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
